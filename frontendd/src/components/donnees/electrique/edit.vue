                        ...
                        <div class="input-box">
                          <div class="form__div">
                            <input
                              ...
                              class="form__input"
                              placeholder=" "
                              id="couplageSecondaire"
                              v-model="projet.couplageSecondaire"
                            />
                            <label for="" class="form__label"
                              >Couplage Secondaire</label
                            >
                          </div>
                        </div>
                        <div class="input-box">
