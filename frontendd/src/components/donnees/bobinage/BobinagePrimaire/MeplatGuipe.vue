                      ...
                      <div class="user-details">
                        <div class="input-box">
                          <div class="form__div">
                            <input
                              ...
                              v-model="projet.scu1"
                            />
                            <label for="" class="form__label">scu1</label>
                          </div>
                        </div>
                        <div class="form__div framei">
                          <input
                            ...
                            v-model="projet.j1"
                          />
                          <label for="" class="form__label">j1</label>
                        </div>
                        ...
                        <div class="form__div framei">
                          ...
                          />
                          <label for="" class="form__label">nbcoucheMT</label>
                        </div>
                        ...
                        <div class="form__div framei">
                          ...
                          />
                          <label for="" class="form__label">nbrPapierMT</label>
                        </div>
                        <div class="form__div framei">
                          <v-select
                            :items="typeCanaux"
                        ...
                        <div class="form__div framei">
                          <input
                            ...
                            readonly
                          />
                          <label for="" class="form__label">canauxMT</label>
                        </div>
                        <div class="form__div framei">
                          <input
                            type="number"
                        ...
                        <div class="form__div framei">
                          ...
                          />
                          <label for="" class="form__label">DintMT</label>
                        </div>
                        <div class="form__div framei">
                          <input
                            type="number"
                          ...
                          />
                          <label for="" class="form__label">BintMT</label>
                        </div>
                      </div>
                    </form>
                  </div>
                      ...
                      <div class="user-details">
                        <div class="input-box">
                          <div class="form__div">
                            ...
                            <label for="" class="form__label">EpxMT</label>
                          </div>
                        </div>
                        <div class="form__div framei">
                          <input
                          ...
                          />
                          <label for="" class="form__label">EpyMT</label>
                        </div>
                        ...
                        <div class="form__div framei">
                          ...
                          />
                          <label for="" class="form__label">DextMT</label>
                        </div>
                        ...
                        <div class="form__div framei">
                          ...
                          />
                          <label for="" class="form__label">BextMT</label>
                        </div>
                        <div class="form__div framei">
                          <input
                            type="number"
                          ...
                          />
                          <label for="" class="form__label">poidMT</label>
                        </div>
                        ...
                        <div class="form__div framei">
                          ...
                          />
                          <label for="" class="form__label">nbBrin1MT</label>
                        </div>
                      </div>
                    </form>
                  </div>
                      ...
                      <div class="user-details">
                        <div class="input-box">
                          <div class="form__div">
                            <input
                              ...
                              placeholder=" "
                              id="nbBrin2MT"
                              v-model="projet.nbBrin2MT"
                            />
                            <label for="" class="form__label">nbBrin2MT</label>
                          </div>
                        </div>
                        <div class="form__div framei">
                          <v-select
                        ...
                        <div class="form__div framei">
                          <input
                            ...
                            v-model="projet.e1ax"
                          />
                          <label for="" class="form__label">e1ax</label>
                        </div>
                        <div class="form__div framei">
                          <input
                            type="number"
                            ...
                            v-model="projet.e1r"
                          />
                          <label for="" class="form__label">e1r</label>
                        </div>
                        <div class="form__div framei">
                          <input
                            type="number"
                            ...
                            placeholder=" "
                            id="J1D"
                            v-model="projet.spCoucheMT"
                          />
                          <label for="" class="form__label">sp/coucheMT</label>
                        </div>
                        <div class="form__div framei">
                          <input
                            type="number"
