        ...
        <v-stepper-items>
          <v-stepper-content step="1">
            <v-card class="mb-12" color="grey lighten-1" height="450px">
              <div class="body">
                <div class="container">
                  <div class="title">Calcul de gradin</div>
                  <div class="content">
                      ...
                      <div class="user-details">
                        <div class="input-box">
                          <div class="form__div">
                            ...
                            />
                            <label for="" class="form__label">Epaisseur </label>
                          </div>
                        </div>
