...
//meplat guipé
    ...
    return $barre;
        ...
        public function updateBobinage($id, Request $request){
            ...
            ->where('projets.id',$id)
            ->select('bobinages.*','bobinages.id as bobine_id','volt_Spires.N2c','volt_Spires.N1c','electriques.PrimaireIPhase','gradins.diamNominale','electriques.secondaireIPhase', 'projets.*')
            ->get()->first();
